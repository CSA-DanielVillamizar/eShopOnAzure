...
- Clone the eShop repository: [https://github.com/dotnet/eshopOnAzure](https://github.com/CSA-DanielVillamizar/eShopOnAzure)
...
For a closely related version of this app that is not Azure specific, please view [the dotnet/eShop][(https://github.com/dotnet/eshop](https://github.com/CSA-DanielVillamizar/eShop-main) repo. These two repos share some common code.
